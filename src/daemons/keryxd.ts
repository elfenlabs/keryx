...
export function keryxd(): DaemonDefinition {
  ...
  return {
    id: 'keryxd',
    order: 5, // Early — so management tools are available before most daemons
        ...
        ctx.addTools([
          createTool({
            ...
            execute: async (args: { id: string }) => {
              ...
              const status = kx.agents.getStatus(args.id)
          ...
          createTool({
            ...
            execute: async (args: { id: string }) => {
              ...
              const messages = kx.agents.getInbox(args.id)
        ...
        ctx.addTools([
          createTool({
            ...
            execute: async (args: { id: string }) => {
              ...
              const count = kx.agents.flushInbox(args.id)
          ...
          createTool({
            ...
            execute: async (args: { id: string }) => {
              ...
              const aborted = kx.agents.abort(args.id)
              if (aborted) {
